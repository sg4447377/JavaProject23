...
public class following_amazon {
	...
	public static void main(String[] args) throws InterruptedException {
		...
		driver.findElement(By.xpath("//input[@id='ap_email']")).sendKeys("7020625992");
			
		Thread.sleep(3000);

	    driver.findElement(By.xpath("//input[@id='ap_email']//following::input[3]")).click();
	    
		Thread.sleep(3000);

	    driver.findElement(By.xpath("//input[@id='ap_email']//following::input[1]")).sendKeys("amazon@1996");
